#run supervised_training.py first to get pickle
import json
...
with open("serialized.pickle","rb") as file:
	deserialized_object = pickle.load(file)

machine = deserialized_object
# print(machine)
