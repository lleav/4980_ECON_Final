...
machine = RandomForestClassifier(n_estimators=150, criterion="gini", max_depth=35)
machine = machine.fit(data_training, target_training)
...
with open("serialized.pickle","wb") as file:
